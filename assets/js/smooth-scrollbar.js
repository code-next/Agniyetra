! function(t, n) { "object" == typeof exports && "object" == typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define([], n) : "object" == typeof exports ? exports.Scrollbar = n() : t.Scrollbar = n() }(this, function() {
    return function(t) {
        ...
        t.exports = function(t, n, e, v, y, m, g) {
            ...
            if (j && (_ = l(j.call(new t))) !== Object.prototype && _.next && (f(_, S, !0), r || c(_, p) || u(_, p, d)), E && M && "values" !== M.name && (O = !0, A = function() { return M.call(this) }), r && !g || !h && !O && T[p] || u(T, p, A), s[n] = A, s[S] = d, y)
        ...
        t.exports = function(t, n, e, v, y, m) {
            ...
            if ("function" == typeof b && (m || _.forEach && !l(function() {
                ...
                M || (b = n(function(n, e) { a(n, b, t); var r = d(new g, n, b); return void 0 != e && s(e, y, r[x], r), r }), b.prototype = _, _.constructor = b), (T || A) && (S("delete"), S("has"), y && S("get")), (A || O) && S(x), m && _.clear && delete _.clear
        ...
        function c(t) {
            var n = ot.call(t, ut),
                e = t[ut];
            try { t[ut] = void 0; var r = !0 } catch (t) {}
            var o = it.call(t);
        ...
        function S(t) {
            ...
            return Object.keys(t).forEach(function(e) {
                ...
                var r = t[e];
                e = e.replace(/^-/, ""), n[e] = r, Nt.forEach(function(t) { n["-" + t + "-" + e] = r })
            }), n
        }
        ...
        function A(t, n, e) {
            var r = t.options,
                ...
                u = t.track,
                c = t.contentEl;
            return r.renderByPixels && (n = Math.round(n), e = Math.round(e)), n = Ot(n, 0, i.x), e = Ot(e, 0, i.y), n !== o.x && u.xAxis.show(), e !== o.y && u.yAxis.show(), r.alwaysShowTracks || u.autoHideOnIdle(), n === o.x && e === o.y ? null : (o.x = n, o.y = e, E(c, { "-transform": "translate3d(" + -n + "px, " + -e + "px, 0)" }), u.update(), { offset: q({}, o), limit: q({}, i) })
        }
        ...
        function L(t, n) {
            return Array.from(Gt.order).filter(function(t) { return !1 !== n[t] }).map(function(e) {
        ...
        function C(t) {
            ...
            function e(t) { return w(t, [l.element, l.thumb.element]) ? Vt.X : w(t, [p.element, p.thumb.element]) ? Vt.Y : void 0 }
            var r, o, i, u, c, s = g(t),
                a = t.containerEl,
                f = t.track,
                l = f.xAxis,
            ...
            s(a, "click", function(r) {
                ...
                if (w(n.target, [l.thumb.element, p.thumb.element])) {
                    ...
                    u = e(o), i = { x: s.x - f.left, y: s.y - f.top }, c = a.getBoundingClientRect(), E(t.containerEl, { "-user-select": "none" })
                }
            ...
            }), s(window, "mouseup blur", function() { r = o = !1, E(t.containerEl, { "-user-select": "" }) })
        }
        ...
        function F(t) {
            function n(r) {
                var o = r.x,
                    i = r.y;
                (o || i) && (t.setMomentum(Ot(u.x + o, 0, c.x) - u.x, Ot(u.y + i, 0, c.y) - u.y), e = requestAnimationFrame(function() { n({ x: o, y: i }) }))
            }
            var e, r = g(t),
                o = t.containerEl,
                i = t.contentEl,
            ...
            }), r(i, "selectstart", function(t) { t.stopPropagation(), cancelAnimationFrame(e), s = !0, E(document.body, { "-user-select": "none" }), E(o, { "-user-select": "auto" }) }), r(window, "mouseup blur", function() { cancelAnimationFrame(e), s = !1, E(document.body, { "-user-select": "" }), E(o, { "-user-select": "" }) }), r(o, "scroll", function(t) { t.preventDefault(), o.scrollTop = o.scrollLeft = 0 })
        }
            ...
            i(r, "touchstart", function(e) { o.track(e), t.setMomentum(0, 0), 0 === u && (n = t.options.damping, t.options.damping = Math.max(n, .5)), u++ }), i(r, "touchmove", function(n) {
                if (!Ut || Ut === t) {
                    ...
                    var e = o.getDelta(),
                        r = e.x,
                        i = e.y;
                    t.addTransformableMomentum(r, i, n, function(e) { e && (n.preventDefault(), Ut = t) })
                }
        ...
        var U = {};
        e.d(U, "keyboardHandler", function() { return N }), e.d(U, "mouseHandler", function() { return C }), e.d(U, "resizeHandler", function() { return R }), e.d(U, "selectHandler", function() { return F }), e.d(U, "touchHandler", function() { return H }), e.d(U, "wheelHandler", function() { return W });
        var X, Y = Object.setPrototypeOf || { __proto__: [] }
        instanceof Array && function(t, n) { t.__proto__ = n } || function(t, n) { for (var e in n) n.hasOwnProperty(e) && (t[e] = n[e]) }, q = Object.assign || function(t) { for (var n, e = 1, r = arguments.length; e < r; e++) { n = arguments[e]; for (var o in n) Object.prototype.hasOwnProperty.call(n, o) && (t[o] = n[o]) } return t }, K = (e(58), e(79), e(84), e(93), e(96), i), $ = u, J = e(98), Q = "object" == typeof self && self && self.Object === Object && self, Z = J.a || Q || Function("return this")(), tt = Z, nt = tt.Symbol, et = nt, rt = Object.prototype, ot = rt.hasOwnProperty, it = rt.toString, ut = et ? et.toStringTag : void 0, ct = c, st = Object.prototype, at = st.toString, ft = s, lt = "[object Null]", pt = "[object Undefined]", ht = et ? et.toStringTag : void 0, dt = a, vt = f, yt = "[object Symbol]", mt = l, gt = NaN, bt = /^\s+|\s+$/g, xt = /^[-+]0x[0-9a-f]+$/i, _t = /^0b[01]+$/i, wt = /^0o[0-7]+$/i, St = parseInt, Et = p, Ot = h, Tt = function() { return tt.Date.now() }, Mt = Tt, At = "Expected a function", Pt = Math.max, jt = Math.min, kt = y, Dt = function() {
            function t(t) {
                void 0 === t && (t = {});
                var n = this;
                this.damping = .1, this.thumbMinSize = 20, this.renderByPixels = !0, this.alwaysShowTracks = !1, this.continuousScrolling = !0, this.wheelEventTarget = null, this.plugins = {}, Object.keys(t).forEach(function(e) { n[e] = t[e] })
            }
            ...
            function t(t) { this.updateTime = Date.now(), this.delta = { x: 0, y: 0 }, this.velocity = { x: 0, y: 0 }, this.lastPosition = { x: 0, y: 0 }, this.lastPosition = _(t) }
        ...
        var Ft, It = function() {
                ...
                return t.prototype.attachTo = function(t) { t.appendChild(this.element) }, t.prototype.update = function(t, n, e) { this.realSize = Math.min(n / e, 1) * n, this.displaySize = Math.max(this.realSize, this._minSize), this.offset = t / e * (n + (this.realSize - this.displaySize)), E(this.element, this._getStyle()) }, t.prototype._getStyle = function() {
            ...
            Ht = function() {
                function t(t, n) { void 0 === n && (n = 0), this.element = document.createElement("div"), this._isShown = !1, this.element.className = "scrollbar-track scrollbar-track-" + t, this.thumb = new It(t, n), this.thumb.attachTo(this.element) }
            ...
            Bt = function() {
                ...
                return t.prototype.onInit = function() {}, t.prototype.onDestory = function() {}, t.prototype.onUpdate = function() {}, t.prototype.onRender = function(t) {}, t.prototype.transformDelta = function(t, n) { return q({}, t) }, t.pluginName = "", t.defaultOptions = {}, t
            }(),
            Gt = { order: new Set, constructors: {} };
        ! function(t) { t[t.SPACE = 32] = "SPACE", t[t.PAGE_UP = 33] = "PAGE_UP", t[t.PAGE_DOWN = 34] = "PAGE_DOWN", t[t.END = 35] = "END", t[t.HOME = 36] = "HOME", t[t.LEFT = 37] = "LEFT", t[t.UP = 38] = "UP", t[t.RIGHT = 39] = "RIGHT", t[t.DOWN = 40] = "DOWN" }(Ft || (Ft = {}));
        var Vt;
        ! function(t) { t[t.X = 0] = "X", t[t.Y = 1] = "Y" }(Vt || (Vt = {}));
        var Ut, Xt = { STANDARD: 1, OTHERS: -3 },
            Yt = [1, 28, 500],
            ...
            $t = function() {
                function t(t, n) {
                    ...
                    this.options = new Dt(n), t.setAttribute("data-scrollbar", "true"), t.setAttribute("tabindex", "1"), E(t, { overflow: "hidden", outline: "none" }), window.navigator.msPointerEnabled && (t.style.msTouchAction = "none"), r.className = "scroll-content", Array.from(t.childNodes).forEach(function(t) { r.appendChild(t) }), t.appendChild(r), this.track = new Wt(this), this.size = this.getSize(), this._plugins = L(this, this.options.plugins);
                    var o = t.scrollLeft,
                        i = t.scrollTop;
                    ...
                    "function" == typeof c && (this._observer = new c(function() { e.update() }), this._observer.observe(r, { subtree: !0, childList: !0 })), Kt.set(t, this), requestAnimationFrame(function() { e._init() })
                }
                return Object.defineProperty(t.prototype, "parent", {
                    ...
                    enumerable: !0,
                    configurable: !0
                }), Object.defineProperty(t.prototype, "scrollTop", { get: function() { return this.offset.y }, set: function(t) { this.setPosition(this.scrollLeft, t) }, enumerable: !0, configurable: !0 }), Object.defineProperty(t.prototype, "scrollLeft", { get: function() { return this.offset.x }, set: function(t) { this.setPosition(t, this.scrollTop) }, enumerable: !0, configurable: !0 }), t.prototype.getSize = function() { return O(this) }, t.prototype.update = function() { M(this), this._plugins.forEach(function(t) { t.onUpdate() }) }, t.prototype.isVisible = function(t) { return T(this, t) }, t.prototype.setPosition = function(t, n, e) {
                    var r = this;
                ...
                }, t.prototype.scrollTo = function(t, n, e, r) { void 0 === t && (t = this.offset.x), void 0 === n && (n = this.offset.y), void 0 === e && (e = 0), void 0 === r && (r = {}), P(this, t, n, e, r) }, t.prototype.scrollIntoView = function(t, n) { void 0 === n && (n = {}), k(this, t, n) }, t.prototype.addListener = function(t) {
                    ...
                    r.forEach(function(t) { n.appendChild(t) }), E(n, { overflow: "" }), n.scrollTop = this.scrollTop, n.scrollLeft = this.scrollLeft, this._plugins.forEach(function(t) { t.onDestory() }), this._plugins.length = 0
                }, t.prototype._init = function() {
                    var t = this;
                    this.update(), Object.keys(U).forEach(function(n) { U[n](t) }), this._plugins.forEach(function(t) { t.onInit() }), this._render()
